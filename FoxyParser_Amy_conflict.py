...
# user enters file path - enter in to the main menu
# assert that file path can be found
# check that contents is an xml
#
#
#
#
def xml_Select(folderpath):
    '''Loads folder to generate a dictionary of LRG files and Gene name'''
...
# user input file path. pass to main function 
filepath = '/Users/Amy/Desktop/LRG_public_xml_files/'
